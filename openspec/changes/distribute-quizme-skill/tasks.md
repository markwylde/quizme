...
- [x] 1.1 Move `SKILL.md` to `skills/quizme/SKILL.md` as the authoritative copy, and verify the existing skill tests still pass against the new path
...
- [x] 2.1 Git-ignore the generated copy under `.claude/skills/quizme/` and stop tracking it, and verify a fresh clone carries exactly one copy of the skill
...
- [x] 3.1 Install the skill into a scratch repository with `npx skills add`, and verify only the quizme skill lands and it is the authoritative text
...
- [x] 4.1 Document installing, updating, and removing in the README, naming `--skill quizme`, and verify the commands work as written by following them from a clean state
