...
- **The preview images in `internal/ui/testdata` will no longer match the form.** → Regenerate with `INTERROGATE_RENDER=1 go test ./internal/ui -run RenderPreview`, and check whether the README references them.
