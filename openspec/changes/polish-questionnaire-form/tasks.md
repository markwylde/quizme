...
- [x] 7.3 Verify by hand that clicking, selecting, and typing in a shielded field are unaffected
...
- [x] 8.4 Run the full suite and one real interrogation, and verify formatting preservation still holds end to end
